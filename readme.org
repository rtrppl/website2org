...
website2org requires [[https://www.gnu.org/software/wget/][wget]] but does not use [[https://pandoc.org/][Pandoc]]. The package parses HTML via [[https://stackoverflow.com/questions/1732348/regex-match-open-tags-except-xhtml-self-contained-tags][RegExp]] to achieve rather minimal looking Orgmode files, see below.
...
Parsing HTML with RegEx comes with lot's of issues. Most experienced coders for good reason strongly advice against doing so. For transforming a website into Orgmode, especially for most modern blog content, these 

Orgmode does not deal well with source blocks within quote blocks. Source blocks without 
